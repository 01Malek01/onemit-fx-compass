...
export default function Auth() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4 py-12 dashboard-bg">
      <Card className="w-full max-w-md border-border/40 shadow-lg fx-card">
