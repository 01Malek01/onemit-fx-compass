          ...
          <Card className="shadow-[0_0_50px_rgba(0,98,255,0.1)] border-white/[0.05] bg-card/30 backdrop-blur-2xl">
            ...
            <Tabs defaultValue="signin" className="w-full">
              <TabsList className="grid w-full grid-cols-2 p-1 mx-6 bg-secondary/50">
                <TabsTrigger 
                  value="signin"
                  className="data-[state=active]:bg-[#0062FF] data-[state=active]:text-white"
                >
                  Sign In
                </TabsTrigger>
                <TabsTrigger 
              ...
              <TabsContent value="signin">
                <form onSubmit={(e) => handleSubmit(e, 'signin')} className="space-y-4 p-6">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input 
                        ...
                        className="pl-10 bg-secondary/50 border-white/[0.05] focus-visible:ring-[#0062FF]"
                        value={email}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input 
                        ...
                        className="pl-10 pr-10 bg-secondary/50 border-white/[0.05] focus-visible:ring-[#0062FF]"
                        value={password}
                      ...
                      <button 
                        ...
                        className="absolute right-3 top-2.5 text-muted-foreground/70 hover:text-foreground/90 transition-colors"
                      >
                        {showPassword ? (
                  ...
                  <Button 
                    type="submit" 
                    className="w-full bg-[#0062FF] hover:bg-[#0062FF]/90 transition-all duration-300" 
